    ...
    <div class="navbar-wrapper  ">
        <div class="navbar-content scroll-div " >
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="{{route('admin.city.index')}}" class="nav-link" style="background: #4680ff;color: #fff;"><span class="pcoded-micon"><i class="feather icon-layout"></i></span><span class="pcoded-mtext">Địa điểm</span></a>
                </li>
                <li class="nav-item">
