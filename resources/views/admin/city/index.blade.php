            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a href="{{route('admin.city.create')}}" class="btn-sm btn-primary float-right"><i class="feather icon-plus"></i> Thêm
                            Mới</a>
                    </div>
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn-sm btn-icon btn-primary"
                                           href="{{route('admin.city.edit',['id'=>$city->id])}}" data-toggle="tooltip"
