                        ...
                        <table class="display table table-striped table-hover">
                            ...
                            @foreach($users as $index => $user)
                                <tr>
                                    ...
                                    <td>
                                        @if($user->is_active)
                                            <a href="{{route('admin.user.disable',['id'=>$user->id])}}"><span class="badge badge-danger">Khóa</span></a>
                                        @else
                                            <a href="{{route('admin.user.enable',['id'=>$user->id])}}"><span class="badge badge-primary">Hoạt Động</span></a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
