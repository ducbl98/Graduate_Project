    ...
    <div class="navbar-wrapper  ">
        <div class="navbar-content scroll-div ">
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="{{route('admin.technique.index')}}" class="nav-link"><span class="pcoded-micon"><i
            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('admin.homepage')}}"><i class="feather icon-home"></i></a></li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a href="{{route('admin.category.create')}}" class="btn-sm btn-primary float-right"><i class="feather icon-plus"></i> Thêm
                            Mới</a>
                    </div>
                    <div class="card-body">
                        <table class="display table table-striped table-hover">
                            ...
                            @foreach($categories as $index => $category)
                                <tr>
                                    ...
                                    <td>{{$category->name}}</td>
                                    <td>
                                        <a class="btn-sm btn-icon btn-primary" href="{{route('admin.category.edit',['id' => $category->id])}}" data-toggle="tooltip"
                                           data-placement="top" title="" data-original-title="Edit">
                                            <i class="feather icon-edit-2"></i>
                                        </a>
                                        <a class="btn-sm btn-icon btn-danger" href="#" data-toggle="tooltip"
