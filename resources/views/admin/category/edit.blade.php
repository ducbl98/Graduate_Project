    ...
    <div class="navbar-wrapper  ">
        <div class="navbar-content scroll-div " >
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="{{route('admin.category.index')}}" class="nav-link" style="background: #4680ff;color: #fff;"><span class="pcoded-micon"><i class="feather icon-layout"></i></span><span class="pcoded-mtext">Danh mục</span></a>
                </li>
                <li class="nav-item">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="category" value="{{old('category') ? old('category') : $category->name}}" class="form-control" placeholder="Danh Mục" />
                                        @error('category')
