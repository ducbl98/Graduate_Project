            ...
            <div class="w-login m-auto">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-12 login-main-right">
                        ...
                        <form action="{{route('seekerRegister')}}" method="POST" class="login-form reg-form">
                            @csrf
                            ...
                            <div class="form-group d-block frm-text">
                                ...
                                <a href="{{route('seekerLogin')}}" class="fg-login float-right d-inline-block">Bạn đã có tài khoản? Đăng Nhập</a>
                            </div>
