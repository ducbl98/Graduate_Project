            ...
            <div class="col-md-12 job-board2-wrap">
                <div class="owl-carousel owl-theme job-board2-contain">
                    ...
                    <div class="item job-latest-item">
                        <a href="{{route('job.showPost',['jobId'=>$job->id])}}" class="job-latest-group">
                            <div class="job-lt-logo">
                                <img src="{{$job->image ? ( str_contains($job->image,'img') ? asset($job->image) :asset('storage/'.$job->image)) : "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/OOjs_UI_icon_userAvatar-constructive.svg/1024px-OOjs_UI_icon_userAvatar-constructive.svg.png"}}">
                            </div>
                            <div class="job-lt-info">
                                <h3>{{$job->title}}</h3>
                                <a class="company" href="#">{{$job->user->name}}</a>
                                <p class="address" ><i class="fa fa-map-marker pr-1" aria-hidden="true"></i> {{$job->province->name}}</p>
                            </div>
                        </a>
                    </div>
                    @endforeach
