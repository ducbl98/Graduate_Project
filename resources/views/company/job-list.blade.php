        ...
        <div class="search-wrapper">
            ...
            <ul class="nav nav-tabs search-nav-tabs" id="myTab" role="tablist">
                <li class="nav-item search-nav-item">
                    <a class="nav-link snav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="true">Tìm công ty</a>
                </li>
            </ul>
                            ...
                            <div class="job-content">
                                ...
                                <div class="wrap-btn-appl">
                                    ...
                                    <a href="{{route('company.post.delete',['id'=>$job->id])}}">
                                        <i class="fa fa-trash-o fa-3x" style="color: #c41212" aria-hidden="true"></i>
                                    </a>
