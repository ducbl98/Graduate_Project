...
<head>
    ...
    <style>
        ...
        .comment .comment-block .comment-header{display:flex;display:-webkit-flex;flex-wrap:wrap;-webkit-flex-wrap:wrap;align-items:flex-end;-webkit-align-items:flex-end;margin:0 0 15px 45px}
                    ...
                    <div class="job-detail-header-desc">
                        ...
                        <div class="job-detail-header-de">
                            <ul>
                                ...
                                <li><i class="fa fa-usd icn-jd"></i><span>{{$job->salary_min}}{{$job->salary_unit}} - {{$job->salary_max}}{{$job->salary_unit}}</span></li>
                    ...
                    <div class="jd-header-wrap-right">
                        <div class="jd-center">
                            @if($isSeeker)
                                ...
                                @else
                                    <a href="javascript:void(0);" class="btn btn-primary btn-apply" data-toggle="modal" data-target="#apply">Ứng tuyển</a>
                                @endif
                            @else
                                <a href="{{route('seekerLogin')}}" class="btn btn-warning btn-login-warning">Đăng nhập để ứng tuyển</a>
                            @endif
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group input-file-container">
                                <input style="width: 770px" type="file" name="resume" id="file" accept="application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document" class="input-file" />
                                ...
                                <div class="row">
                                    <div class="col-6 pr-10">
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <input type="text" class="w-full" id="mf_phone" name="phone_number" value="{{old('phone_number') ? old('phone_number') :($seeker ? $seeker->phone_number : '')}}" placeholder="Số điện thoại">
                                            @error('phone_number')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-6 pl-10">
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <input type="email" class="w-full" id="mf_email" name="email" value="{{old('email') ? old('email') :($seeker ? $seeker->user->email : '')}}" placeholder="Email">
                                            @error('email')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
