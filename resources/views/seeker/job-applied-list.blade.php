        ...
        <div class="row">
            <div class="col-md-8 col-sm-12 col-12 recuitment-inner mt-3">
                <div class="recuitment-form">
                    <h3 class="rect-heading" style="font-size: 28px; padding-left: 22px; font-weight: 500;">Các đơn đã ứng tuyển</h3>
                    <hr class="break-line">
                            ...
                            <table class="table">
                                ...
                                @foreach($appliedJobs as $appliedJob)
                                    ...
                                    >
                                        ...
                                        <td>
                                            <a href="{{route('seeker.job.apply.detail',['id'=>$appliedJob->id])}}" class="btn-sm btn-primary"><i class="fa fa-eye"></i></a>
                                            <a href="{{route('seeker.job.apply.delete',['id'=>$appliedJob->id])}}" class="btn-sm btn-danger"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </table>
