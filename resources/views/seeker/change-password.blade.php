        ...
        <div class="row">
            <div class="col-md-8 col-sm-12 col-12 recuitment-inner">
                <div class="recuitment-form">
                    <h3 class="rect-heading" style="font-size: 28px; padding-left: 22px; font-weight: 500;">Thay đổi mật khẩu</h3>
                    <hr class="break-line">
                    <div class="user--profile-right">
                        <div class="user--profile-group">
                            <div class="row rowdiv">
                                <form action="{{route('seeker.change-password.post')}}" method="POST" style="width: 90%">
                                    @csrf
                                    <div class="form-group">
                                        <label for="oldPassword">Mật khẩu cũ</label>
                                        <input name="oldPassword" type="password" class="form-control" id="oldPassword" placeholder="Nhập mật khẩu cũ" data-toggle="password">
                                        @error('oldPassword')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="newPassword" type="password" class="form-control" id="newPassword" placeholder="Nhập mật khẩu mới" data-toggle="password">
                                        @error('newPassword')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        <label for="newPasswordConfirmation">Mật khẩu mới nhập lại</label>
                                        <input name="newPassword_confirmation" type="password" class="form-control" id="newPasswordConfirmation" placeholder="Nhập lại mật khẩu mới" data-toggle="password">
                                        @error('newPassword')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
